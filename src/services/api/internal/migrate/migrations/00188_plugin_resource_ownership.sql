...
ALTER TABLE profile_mcp_installs
    ADD COLUMN IF NOT EXISTS owner_plugin_id TEXT,
    ADD COLUMN IF NOT EXISTS owner_plugin_version TEXT;
...
ALTER TABLE profile_skill_installs
    DROP COLUMN IF EXISTS owner_plugin_version,
    DROP COLUMN IF EXISTS owner_plugin_id;
